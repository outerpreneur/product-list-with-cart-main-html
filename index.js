    ...
    data.forEach((dessert) => {
      ...
      card.innerHTML = `
        <picture class="relative">
          ...
          <button class="add-to-cart bg-white text-rose-900 text-xs px-4 py-2 rounded-3xl border border-rose-400 absolute bottom-[-18px] left-1/2 transform -translate-x-1/2 flex gap-1">
      ...
      // Attach event listener to the button after appending to the DOM
